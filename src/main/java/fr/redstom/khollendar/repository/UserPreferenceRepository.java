...
public interface UserPreferenceRepository extends JpaRepository<UserPreference, Long> {
    ...
    /**
     * Trouve toutes les préférences d'un utilisateur pour une session donnée,
     * ordonnées par rang de préférence
     */
    ...
    /**
     * Récupère toutes les préférences pour une session, triées par utilisateur puis par rang de préférence
     */
    @Query("SELECT up FROM UserPreference up WHERE up.session = :session ORDER BY up.user.id ASC, up.preferenceRank ASC")
